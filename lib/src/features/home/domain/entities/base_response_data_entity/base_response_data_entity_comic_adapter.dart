...
class BaseResponseDataEntityComicAdapter
    extends TypeAdapter<BaseResponseDataEntity<ComicEntity>> {
  @override
  final int typeId = HiveIds.baseResponseDataEntityComicId;

  @override
  BaseResponseDataEntity<ComicEntity> read(BinaryReader reader) {
    ...
    return BaseResponseDataEntity(
      ...
      results: (fields[4] as List).cast<ComicEntity>(),
      characterId: fields[5] as num?,
    );
  }

  @override
  void write(BinaryWriter writer, BaseResponseDataEntity<ComicEntity> obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.offset)
  ...
  bool operator ==(Object other) =>
      ...
      other is BaseResponseDataEntityComicAdapter &&
